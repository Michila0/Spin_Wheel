...
function spin() {
    ...
    let Michila = shuffle([1890, 2250, 2610]);
    let Peter = shuffle([1850, 2210, 2570]);
    ...
    if(Michila.includes(result[0])) SelectItem = "Air Conditioner";
    if(Peter.includes(result[0])) SelectItem = "Camera Sport Action";
